...
[^1] Spatial Clustering: Refers to the phenomenon where similar types of criminal behavior are concentrated in specific geographic areas. This often indicates that certain locations, due to their environmental or socio-economic characteristics, are more prone to specific types of crime.
